...
procedure TestTUtilities.TestcepLength;
var
  ReturnValue: Boolean;
  CEP: string;
begin
  CEP := '75901653112';
  ReturnValue := FUtilities.cepLength(CEP);

  CheckFalse(ReturnValue,'Teste falho quantidade de caracteres inválida');
end;
